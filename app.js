...
var myUserId = process.argv[2] || "@huyphan123:my-first.matrix.host";
var myAccessToken = process.argv[3] || "syt_aHV5cGhhbjEyMw_fIaQymhKEHXkYJhQQpVE_37AmTO";
...
function printRoomInfo(room) {
    ...
    Array.from(eventMap.keys()).forEach(function (eventType) {
        if (eventType === "m.room.member") {
            return;
        } // use /members instead.
        var eventEventMap = eventMap.get(eventType);
        Array.from(eventEventMap.keys()).forEach(function (stateKey) {
